...
namespace MietSchedule.Server.Controllers
{
    ...
    public class ScheduleController : ControllerBase
    {
        ...
        public ScheduleController(PairService coupleService, IOptions<FormatSettings> options)
        {
        ...
        [HttpGet("{group}")]
        public async Task<IEnumerable<PairDto>> GetGroupScheduleAsync(string group, string dateString, CancellationToken cancellationToken, string ignored = "")
        {
        ...
        public async Task<IEnumerable<TeacherPairGroupedDto>> GetTeacherScheduleAsync(string teacher, string startDate, string endDate, CancellationToken cancellationToken)
        {
